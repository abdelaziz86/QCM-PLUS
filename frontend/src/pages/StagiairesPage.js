    ...
    const handleDelete = (id, nom, prenom) => {
        if (window.confirm(`Êtes-vous sûr de vouloir supprimer ${prenom} ${nom} ?`)) {
            axios.delete(`http://localhost:5000/api/users/${id}`)
                .then(() => {
                    setStagiaires(prev => prev.filter(user => user.id !== id));
                })
            ...
            <header className="page-header-gradient">
                <div className="header-content">
                    <div className="header-text">
                        <h1><FaUsers className="header-icon" /> Gestion des Stagiaires</h1>
                        <p>Gérez les comptes stagiaires de votre organisation</p>
                    </div>
            ...
            <div className="main-content">
                {stagiaires.length === 0 ? (
                    <div className="empty-state">
                        ...
                        <p>Commencez par créer votre premier stagiaire</p>
                ...
                <div className="dialog-overlay">
                    <div className="dialog-box">
                        <div className="dialog-header">
                            <h3>{editingUser ? 'Modifier le stagiaire' : 'Créer un nouveau stagiaire'}</h3>
